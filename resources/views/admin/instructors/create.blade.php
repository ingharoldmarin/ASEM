...
<div class="max-w-lg">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('admin.instructors.store') }}" method="POST" class="space-y-4">
            @csrf
            <div>
            ...
            <div class="flex gap-3 pt-2">
                ...
                <a href="{{ route('admin.instructors') }}" class="text-sm text-gray-600 hover:text-gray-800 px-3 py-2">Cancelar</a>
            </div>
        </form>
    </div>
</div>
